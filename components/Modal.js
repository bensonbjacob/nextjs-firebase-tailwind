...
export default function Modal(props) {
  ...
  return ReactDOM.createPortal(
    <div className='fixed w-screen h-screen inset-0 bg-white text-slate-900 flex flex-col text-base sm:text-xl'>
      <div className='flex items-center justify-between border-b border-solid border-slate-900 p-4'>
        ...
        <p
          className='duration-300 hover:rotate-90 cursor-pointer text-lg sm:text-3xl'
